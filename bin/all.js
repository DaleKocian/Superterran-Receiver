...
goog.exportSymbol("cast.games.superterran.SuperterranGame", cast.games.superterran.SuperterranGame);
cast.games.superterran.SuperterranGame.FIRE_FIELD_ = "fire";
...
goog.exportProperty(cast.games.superterran.SuperterranGame.prototype, "run", cast.games.superterran.SuperterranGame.prototype.run);
...
goog.exportProperty(cast.games.superterran.SuperterranGame.prototype, "stop", cast.games.superterran.SuperterranGame.prototype.stop);
...
cast.games.superterran.SuperterranGame.prototype.update_ = function() {
  if (this.isRunning_) {
    requestAnimationFrame(this.boundUpdateFunction_);
    this.fireThisFrame_ = !1;
...
cast.games.superterran.SuperterranGame.prototype.onPlayerAvailable_ = function(event) {
...
cast.games.superterran.SuperterranGame.prototype.onPlayerQuit_ = function(event) {
  if (event.statusCode != cast.receiver.games.StatusCode.SUCCESS) {
    console.log("Error: Event status code: " + event.statusCode), console.log("Reason for error: " + event.errorDescription);
  } else {
...
cast.games.superterran.SuperterranGame.prototype.onGameMessage_ = function(event) {
  if (event.statusCode != cast.receiver.games.StatusCode.SUCCESS) {
    ...
    var moveField = event.requestExtraMessageData[cast.games.superterran.SuperterranGame.MOVE_FIELD_];
    this.onPlayerMessage_(player, !!event.requestExtraMessageData[cast.games.superterran.SuperterranGame.FIRE_FIELD_], moveField ? parseFloat(moveField) : 0);
  }
};
cast.games.superterran.SuperterranGame.prototype.onPlayerMessage_ = function(player, fire, move) {
...
cast.games.superterran.SuperterranGame.prototype.willCollide_ = function(sprite1, sprite2) {
...
cast.games.superterran.SuperterranGame.prototype.hideExplosion_ = function(explosion) {
  explosion.visible = !1;
};
